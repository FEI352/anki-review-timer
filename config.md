...
- **auto_grade_grace_seconds**: Delay (seconds) between the answer being shown and the auto-grade firing. Gives you a moment to read the answer first (default: `30`)
